...
datasets = pd.DataFrame(x_data, columns=datasets.feature_names)

datasets = datasets.drop(columns=['worst concavity', 'concavity error', 'mean symmetry', 'mean perimeter'])
