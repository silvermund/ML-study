...
print(x1.shape) #(2168, 5, 4)

x1 = x1.reshape(2168*5, 4)
...
print('mse: ',results[1])
print('2022년 1월 1일 주택가격지수 : ', y_predict[-1])
# print("r2스코어 :", r2)
...
# 
# 걸린 시간 :  88.94098424911499
# loss:  14.83984375
# mse:  2.8437142372131348
# 2022년 1월 1일 주택가격지수 :  [101.01018]

# 걸린 시간 :  148.31511664390564
# loss:  7.9604620933532715
# mse:  2.1187617778778076
# 2021년 12월 1일 주택가격지수 :  [97.84205]

# 걸린 시간 :  127.23975968360901
# loss:  7.593505859375
# mse:  2.0837149620056152
# 2022년 1월 1일 주택가격지수 :  [98.01926]


# 걸린 시간 :  55.25710582733154
# loss:  42.98187255859375
# mse:  4.937697410583496
# 2022년 1월 1일 주택가격지수 :  [103.81364]

# 걸린 시간 :  36.947999477386475
# loss:  56.93605041503906
# mse:  5.587579250335693
# 2022년 1월 1일 주택가격지수 :  [126.7851]

# 걸린 시간 :  72.64855694770813
# loss:  9.564359664916992
# mse:  2.453535318374634
# 2022년 1월 1일 주택가격지수 :  [103.15567]

# 걸린 시간 :  59.90328812599182
# loss:  16.76103401184082
# mse:  3.27886962890625
# 2022년 1월 1일 주택가격지수 :  [103.29884]

# 걸린 시간 :  126.79629349708557
# loss:  9.205759048461914
# mse:  2.530252456665039
# 2022년 1월 1일 주택가격지수 :  [104.46775]

# 걸린 시간 :  95.18727087974548
# loss:  10.836520195007324
# mse:  2.3818860054016113
# 2022년 1월 1일 주택가격지수 :  [99.60551]