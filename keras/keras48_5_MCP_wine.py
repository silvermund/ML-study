...
# model.add(LSTM(16, activation='relu', input_length=11, input_dim=1))
...
# cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', filepath='./_save/ModelCheckPoint/keras48_5_MCP.hdf5')


start_time = time.time()
# model.fit(x_train, y_train, epochs=100, batch_size=64, validation_split=0.25, callbacks=[es, cp])
end_time = time.time() - start_time

# model.save('./_save/ModelCheckPoint/keras48_5_model_save.hdf5')

# model = load_model('./_save/ModelCheckPoint/keras48_5_model_save.hdf5')
...
lstm
time :  15.9050931930542
loss :  8.004231452941895
acc :  0.3959183692932129

conv1d
time :  3.950038194656372
loss :  10.67350959777832
acc :  0.1795918345451355

model
time :  3.157961845397949
loss :  8.250588417053223
acc :  0.1428571492433548

MCP
time :  3.2929723262786865
loss :  4.0255126953125
acc :  0.22857142984867096
'''
