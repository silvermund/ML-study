...
from tensorflow.keras.layers import Dense, Input, concatenate, Concatenate, Conv2D, Conv1D, Flatten, MaxPool2D, LSTM
...
print(x_train.shape, y_train.shape) #(66, 5) (66,)
print(x_test.shape, y_test.shape) #(29, 5) (29,)
...
print(x_train.shape, y_train.shape)  #(66, 5, 1) (66,)
print(x_test.shape, y_test.shape)  #(29, 5, 1) (29,)
...
'''
rmse score :  6.456142557129923
걸린 시간 :  4.332976579666138
r2스코어 : 0.9373279205123547
'''