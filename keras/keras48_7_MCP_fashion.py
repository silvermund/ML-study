...
x_train = x_test.reshape(10000, 784, 1)
...
# cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', filepath='./_save/ModelCheckPoint/keras48_7_MCP.hdf5')
...
# model.save('./_save/ModelCheckPoint/keras48_7_model_save.hdf5')

# model = load_model('./_save/ModelCheckPoint/keras48_7_model_save.hdf5')
...
'''
'''
loss :  0.9540009498596191
accuracy :  0.9004999995231628

dnn
걸린 시간 :  99.04595041275024
loss :  0.7047482132911682
accuracy :  0.8828999996185303

lstm
걸린 시간 :  531.3989005088806
loss :  2.3030407428741455
accuracy :  0.10090000182390213

model
걸린 시간 :  878.3304252624512
loss :  2.3032422065734863
accuracy :  0.10000000149011612

mcp
걸린 시간 :  972.2576982975006
loss :  2.3032848834991455
accuracy :  0.10000000149011612
'''