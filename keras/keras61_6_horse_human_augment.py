...
# print(randidx)    
print(randidx.shape)        #(700,)

x_augmented = x_train[randidx].copy()
y_augmented = y_train[randidx].copy()

print(x_augmented.shape) #(700, 150, 150, 3)
...
print(x_train.shape, y_train.shape) #(1727, 150, 150, 3) (1727, 2)
...
# 걸린 시간 :  81.52787780761719
# acc :  0.8479362726211548
# val_acc :  0.4450867176055908
