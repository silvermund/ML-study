...
from tensorflow.keras.layers import Dense, Input, concatenate, Concatenate, SimpleRNN
...
xx = SimpleRNN(10, activation='relu', input_length=3, input_dim=1)(input1)
...
xx = SimpleRNN(10, activation='relu', input_length=3, input_dim=1)(input2)
