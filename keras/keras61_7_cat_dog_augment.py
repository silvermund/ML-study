...
# print(randidx)    
print(randidx.shape)        #(1620,)

x_augmented = x_train[randidx].copy()
y_augmented = y_train[randidx].copy()

print(x_augmented.shape) #(1620, 150, 150, 3)
...
print(x_train.shape, y_train.shape) #(9625, 150, 150, 3) (9625,)
...
# after aug
# 걸린 시간 :  520.8750977516174
# acc :  0.9827272891998291
# val_acc :  0.49974027276039124
