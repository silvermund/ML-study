...
# cp = ModelCheckpoint(monitor='val_loss', save_best_only=True, mode='auto', filepath='./_save/ModelCheckPoint/keras48_1_MCP.hdf5')


start_time = time.time()
# model.fit(x_train, y_train, epochs=100, batch_size=16, validation_split=0.25, callbacks=[es, cp])
end_time = time.time() - start_time

# model.save('./_save/ModelCheckPoint/keras48_model_save.hdf5')

# model.save('./_save/ModelCheckPoint/keras48_MCP.hdf5')

model = load_model('./_save/ModelCheckPoint/keras48_MCP.hdf5')
...
conv1d
time =  3.929975748062134
loss :  21.552736282348633
R^2 score :  0.7247199887492042

model
time =  3.8365018367767334
loss :  21.829608917236328
R^2 score :  0.7211836686092746

MCP
time =  3.7573814392089844
loss :  21.521652221679688
R^2 score :  0.7251170238441684
'''
