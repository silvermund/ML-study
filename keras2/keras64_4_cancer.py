...
x_train = x_train.reshape(x_train.shape[0],30,1).astype('float32')/255.
x_test = x_test.reshape(x_test.shape[0],30,1).astype('float32')/255.

#2. 모델
def build_model(drop=0.2, optimizer='adam'):
    inputs = Input(shape=(30, 1), name='input')
...
# 1/1 [==============================] - 3s 3s/step - loss: 0.6931 - acc: 0.3860
# 최종 스코어 :  0.38596490025520325